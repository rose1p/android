...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into product(name, price) values('프링글스', 2500)");
        db.execSQL("insert into product(name, price) values('농심 새우깡', 1300)");
        db.execSQL("insert into product(name, price) values('이구동성', 2800)");
    }
